<%-- 
    Document   : baseLayout
    Created on : May 7, 2017, 5:37:27 PM
    Author     : Dinuzhka
--%>
<%@page import="com.sqeteam.recruitresource.model.Persons"%>
                        ...
                        <li class="light-blue dropdown-modal">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                ...
                                <span class="user-info">
                                    <small>Welcome,</small>
                                    <%= session.getAttribute("logged_person") != null ? ((Persons) session.getAttribute("logged_person")).getFirstName() : ""%>
                                </span>
                ...
                <div class="footer-inner">
                    <div class="footer-content">
                        <span class="bigger-120">
                            <span class="blue bolder">Recruit Resource</span>
                            sqe application &copy; 2017
                        </span>
